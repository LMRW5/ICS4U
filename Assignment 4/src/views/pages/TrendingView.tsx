import { ButtonGroup, ImageGrid, LinkGroup } from "@/components";
  ...
  return (
    <section className="max-w-[1200px] mx-auto p-5 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <ButtonGroup
          buttons={[
            { label: "Today", to: `/trending/${activeChoice}?interval=day`, matchParams: { interval: "day" } },
            { label: "Week", to: `/trending/${activeChoice}?interval=week`, matchParams: { interval: "week" } },
          ]}
        />
      </div>
      {gridData && mediaData && (
